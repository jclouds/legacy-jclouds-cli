...
if [%1]==[] (
        ...
        echo "--client-name:        The name of the client."
        echo "--client-key-file:    The path to the client key file."
        echo "--validator-name:     The name of the validator."
        echo "--validator-key-file: The path to the validator key file."
